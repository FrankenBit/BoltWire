...
namespace FrankenBit.BoltWire
{
    internal sealed class CollectionRegistration : ICollectionRegistration
    {
        ...
        internal CollectionRegistration([NotNull] Type serviceType, [NotNull] IRegistration existingRegistration)
        {
        ...
        [ItemNotNull]
        [NotNull]
        private static IEnumerable<object> GetInstances([ItemNotNull] [NotNull] List<IRegistration> registrations,
            [NotNull] IDictionary<Type, object> parameters) =>
