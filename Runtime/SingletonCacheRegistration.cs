...
namespace FrankenBit.BoltWire
{
    internal sealed class SingletonCacheRegistration : IDisposable, IRegistration
    {
        ...
        internal SingletonCacheRegistration([NotNull] IRegistration registration) =>
        ...
        [NotNull]
        private object CreateInstance([NotNull] IDictionary<Type, object> parameters) =>
            StoreIfDisposable(_registration.GetInstance(parameters));

        [NotNull]
        private object StoreIfDisposable([NotNull] object instance)
        {
